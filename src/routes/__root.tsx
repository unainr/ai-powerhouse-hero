...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Power AI" },
      { name: "twitter:description", content: "The most powerful AI ever deployed in talent acquisition." },
    ],
    links: [
      {
        rel: "stylesheet",
